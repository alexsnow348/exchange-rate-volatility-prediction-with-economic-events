...
checkpointer = ModelCheckpoint(
    monitor='val_loss', filepath='../model/without_ecoevent/model_2_without.hdf5', verbose=1, save_best_only=True)
...
# Model 2 Test Result
model2.load_weights("../model/without_ecoevent/model_2_without.hdf5")
