...
inputs = df.drop(labels=["timestamp", "std", "impact"], axis=1)
inputs = df.drop(labels=["std", "impact"], axis=1)
...
checkpointer = ModelCheckpoint(
    monitor='val_loss', filepath='../model/without_ecoevent/model_1_without.hdf5', verbose=1, save_best_only=True)
...
# Model 1 Test Result
model1.load_weights("../model/without_ecoevent/model_1_without.hdf5")
